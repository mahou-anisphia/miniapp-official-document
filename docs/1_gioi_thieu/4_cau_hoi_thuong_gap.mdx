...
Miniapp chạy trong môi trường sandbox của Tammi Superapp, có quyền truy cập vào các tính năng native (camera, GPS, bluetooth...) thông qua jsAPI. Web app thông thường chỉ chạy trong browser với các API web tiêu chuẩn.
...
Có. Vì jsAPI là tùy chọn, một SPA thuần có thể chạy trực tiếp trên nền tảng miniapp mà không cần chỉnh sửa nhiều. Xem [Hướng dẫn tích hợp SPA](../quick_start/tich_hop_spa).
...
<details>
<summary>jsAPI là gì?</summary>

jsAPI là lớp trung gian cho phép miniapp giao tiếp với các tính năng native của thiết bị. Mọi tương tác với camera, GPS, bluetooth, file system... đều phải đi qua jsAPI.
...
Miniapp chạy trong sandbox — môi trường cách ly để đảm bảo bảo mật và ổn định. jsAPI là cầu nối duy nhất được SuperApp cung cấp và kiểm soát.
